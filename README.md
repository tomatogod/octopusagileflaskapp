...
You can integrate this app with Home Assistant using a REST sensor. Add the following to your `configuration.yaml`:

```yaml
sensor:
  - platform: rest
    resource: http://octopusagileflaskapp.home:5000/currentelectric
    name: current_electric_price
    unit_of_measurement: "GBP/kWh"
    scan_interval: 60
    timeout: 60
    unique_id: current_electric_price_restsensor
```

This creates a sensor that polls the current electricity price every 60 seconds.
